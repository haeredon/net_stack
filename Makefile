...
SRCS-HANDLERS := handlers/pcapng/pcapng.c handlers/ethernet/ethernet.c handlers/handler.c handlers/arp/arp.c handlers/protocol_map.c handlers/ipv4/ipv4.c handlers/null/null.c handlers/tcp/tcp.c handlers/tcp/tcp_block_buffer.c handlers/tcp/tcp_tcb.c handlers/tcp/tcp_shared.c
