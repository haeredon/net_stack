...
SRCS-TEST := test/main.c test/pcapng.c test/ipv4/test.c test/common.c test/tcp/test.c  test/tcp/utility.c test/tcp/overrides.c test/tcp/tests/download_1/download_1.c
SRCS-DEV := main_dev.c
INCLUDES-TEST := -I ./ 
SRCS-y := main.c worker.c 
SRCS-HANDLERS := handlers/pcapng/pcapng.c handlers/ethernet/ethernet.c handlers/handler.c handlers/arp/arp.c handlers/protocol_map.c handlers/ipv4/ipv4.c handlers/custom/custom.c handlers/tcp/tcp.c handlers/tcp/tcp_block_buffer.c handlers/tcp/socket.c handlers/tcp/tcp_shared.c
